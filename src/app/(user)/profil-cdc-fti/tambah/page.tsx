...
import { createProfilCdcFti } from "@/services/profilCdcFti";
...
export default function page() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    e.preventDefault();
    if (!imgFile || !visionImgFile || !missionImgFile || !goalImgFile || !benefitImgFile) {
    ...
    const { success, error } = await createProfilCdcFti(formData);
    if (success) {
