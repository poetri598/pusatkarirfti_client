...
export default function page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { success, error } = await createProvince(formData);
    if (success) {
      ...
      <>
        <main className="xs:p-0 md:p-8  flex flex-col xs:gap-2 md:gap-8 overflow-hidden">
          ...
          >
            ...
            <BreadcrumbItem href="/provinsi/tambah">Tambah Provinsi</BreadcrumbItem>
          </Breadcrumbs>

          {/* Section Title */}
          <TitleSectionAdmin label="Tambah Provinsi" />
