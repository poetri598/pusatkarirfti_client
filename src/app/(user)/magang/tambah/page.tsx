...
import { createInternship } from "@/services/internship";
...
export default function page() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // --- SINGLE: internship_type_id, company_id, ipk_id
    ...
    // Kirim ke server
    const { success, error } = await createInternship(formData);
      ...
      <>
        <main className="xs:p-0 md:p-8  flex flex-col xs:gap-2 md:gap-8 overflow-hidden">
          ...
          >
            ...
            <BreadcrumbItem href="/magang/tambah">Tambah Magang</BreadcrumbItem>
          </Breadcrumbs>

          {/* Section Title */}
          <TitleSectionAdmin label="Tambah Magang" />
