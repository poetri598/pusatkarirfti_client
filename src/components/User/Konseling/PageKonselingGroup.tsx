...
export default function CounselingGroup() {
  const { user } = useAuth();
  ...
  const [counselingType, setCounselingType] = useState<Selection>(new Set(["3"]));
      ...
      <>
        <main className="xs:w-11/12 lg:w-10/12 bg-background-primary mx-auto flex flex-col py-8 gap-8">
          ...
          >
            ...
            <BreadcrumbItem href="/konseling/counseling-group">Counseling Group</BreadcrumbItem>
          </Breadcrumbs>
          <Form onSubmit={handleSubmit} className="flex flex-col bg-background-primary rounded-md xs:shadow-none md:shadow-lg gap-8 xs:p-0 md:p-8">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <p className="xs:text-base md:text-4xl text-primary-primary font-bold">Counseling Group</p>
                <People size={8} color="currentColor" variant="Bulk" className="text-primary-primary xs:w-8 xs:h-8" />
              </div>
